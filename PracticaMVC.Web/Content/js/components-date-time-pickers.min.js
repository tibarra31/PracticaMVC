var ComponentsDateTimePickers = function () {
    ...
    var handleDateRangePickers = function () {
        ...
        $('#defaultrange').on('click', function () {
            if ($('#defaultrange').is(":visible") && $('body').hasClass("modal-open") == false) {
        ...
        $('#defaultrange2').daterangepicker({
            ...
            function (start, end) {
                $('#defaultrange2 input').val(start.format('DD/MM/YYYY') + ' - ' + end.format('DD/MM/YYYY'));
            }
        );

        $('#defaultrange2').on('click', function () {
            if ($('#defaultrange2').is(":visible") && $('body').hasClass("modal-open") == false) {
                $('body').addClass("modal-open");
            }
        });

        $('#defaultrange2_modal').daterangepicker({
            opens: (App.isRTL() ? 'left' : 'right'),
            format: 'MM/DD/YYYY',
            separator: ' to ',
            startDate: moment().subtract('days', 29),
            ...
            function (start, end) {
                $('#defaultrange2_modal input').val(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
            }
        );

        // this is very important fix when daterangepicker is used in modal. in modal when daterange picker is opened and mouse clicked anywhere bootstrap modal removes the modal-open class from the body element.
        // so the below code will fix this issue.
        $('#defaultrange2_modal').on('click', function () {
            if ($('#daterangepicker_modal').is(":visible") && $('body').hasClass("modal-open") == false) {
                $('body').addClass("modal-open");
            }
        });
        ...
        $('#reportrange').daterangepicker({
            ...
            function (start, end) {
                $('#reportrange span').html(start.format('D/MM/YYYY') + ' - ' + end.format('MMMM D, YYYY'));
            }
        );

        $('#reportrange').on('click', function () {
            if ($('#reportrange').is(":visible") && $('body').hasClass("modal-open") == false) {
                $('body').addClass("modal-open");
            }
        });
